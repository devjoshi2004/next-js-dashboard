...
function createServerSearchParamsForServerPage(underlyingSearchParams, workStore) {
    ...
    if (workUnitStore) {
        switch(workUnitStore.type){
            ...
            case 'prerender-runtime':
                return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$server$2f$app$2d$render$2f$dynamic$2d$rendering$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["delayUntilRuntimeStage"])(workUnitStore, createRenderSearchParams(underlyingSearchParams, workStore));
            case 'request':
                break;
            default:
                workUnitStore;
...
function createServerParamsForRoute(underlyingParams, workStore) {
    ...
    if (workUnitStore) {
        switch(workUnitStore.type){
            ...
            case 'prerender-runtime':
                return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$server$2f$app$2d$render$2f$dynamic$2d$rendering$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["delayUntilRuntimeStage"])(workUnitStore, createRenderParams(underlyingParams, workStore));
            case 'request':
                break;
            default:
                workUnitStore;
