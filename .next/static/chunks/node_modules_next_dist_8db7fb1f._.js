...
function createServerSearchParamsForServerPage(underlyingSearchParams, workStore) {
    ...
    if (workUnitStore) {
        switch(workUnitStore.type){
            ...
            case 'prerender-runtime':
                return (0, _dynamicrendering.delayUntilRuntimeStage)(workUnitStore, createRenderSearchParams(underlyingSearchParams, workStore));
            case 'request':
                break;
            default:
                workUnitStore;
...
function createServerParamsForRoute(underlyingParams, workStore) {
    ...
    if (workUnitStore) {
        switch(workUnitStore.type){
            ...
            case 'prerender-runtime':
                return (0, _dynamicrendering.delayUntilRuntimeStage)(workUnitStore, createRenderParams(underlyingParams, workStore));
            case 'request':
                break;
            default:
                workUnitStore;
